...
import static com.example.tesh.Cart.Cart.mangsp;
...
public class cartadapter extends BaseAdapter {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if(view ==null){
            ...
            viewHoler.txttensp= view.findViewById(R.id.txtnamesp);
            viewHoler.txtgiasp=view.findViewById(R.id.txtpricesp);
            viewHoler.imgsp=view.findViewById(R.id.imgsp);
            viewHoler.btnminus=view.findViewById(R.id.btnminus);
            viewHoler.btnplus=view.findViewById(R.id.btnplus);
            viewHoler.btnvalues=view.findViewById(R.id.numner);
            viewHoler.cbitem=view.findViewById(R.id.CBitem);
       ...
       // }
        ...
        viewHoler.btnplus.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                int slht= mangsp.get(i).getSoluongsp();
                int giaht= mangsp.get(i).getGiasp();
                mangsp.get(i).setSoluongsp(slmoinhat);
                int giamoinhat=(giaht*slmoinhat)/slht;
               mangsp.get(i).setGiasp(giamoinhat);
